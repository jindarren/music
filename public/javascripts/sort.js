...
var handleLogicGroups = function (subsets, level, parentGroup) {
    ...
    UpSetState.logicGroups.forEach(function (d) {
        ...
        var group = new QueryGroup(d.id, d.groupName, d.orClauses, d.elements);
...
var groupBySet = function (subSets, level, parentGroup) {
    //console.log("group by settttttttttt");
    var newGroups = [];
...
var sortBySetItem = function (subSets, set) {
    ...
    dataRows.sort(function (a, b) {
        ...
        // move all elements with more intersections to the top
        if (a.nrCombinedSets !== b.nrCombinedSets) {
            return b.nrCombinedSets - a.nrCombinedSets;
        }
...
var sortByCombinationSizeAscend = function (subSets) {
    var dataRows = getFilteredSubSets(subSets);
...
var sortByCombinationSizeDescend = function (subSets) {
    var dataRows = getFilteredSubSets(subSets);
...
var sortBySubSetSizeAscend = function (subSets) {
    var dataRows = getFilteredSubSets(subSets);
    dataRows.sort(function (a, b) {
...
var StateMap = {
    ...
    sortByCombinationSizeAscend: sortByCombinationSizeAscend,
    sortByCombinationSizeDescend: sortByCombinationSizeDescend,
    sortBySubSetSize: sortBySubSetSize,
    sortBySubSetSizeAscend: sortBySubSetSizeAscend,
...
var UpSetState = {
    ...
    sorting: StateOpt.sortBySubSetSizeAscend,
...
var updateState = function (parameter) {
    ...
    if ((UpSetState.sorting && !UpSetState.grouping) && (forceUpdate || (previousState && previousState.sorting !== UpSetState.sorting))) {
        ...
        levelOneGroups = StateMap[StateOpt.groupBySet](subSets, 1, "");
    }
    ...
    dataRows.forEach(function (element) {
        ...
        if (UpSetState.grouping === StateOpt.groupBySet || UpSetState.levelTwoGrouping === StateOpt.groupBySet) {
            ...
            var ids = element.id.toString().split("_");
            if(ids[0] == "LogicGroup"){
                type = GROUP_TYPE.QUERY;
                //console.log("logicccccccc");
            }
            else if(ids[0] == "FILTER")
            {
                type = GROUP_TYPE.NONQUERY;
            }
