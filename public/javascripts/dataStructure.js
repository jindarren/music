...
var renderRows = [];
/** The dynamically created subSets; chen: store all possible subsets*/
var subSets = [];
...
/** The depth of the dataset, i.e., how many records it contains chen: number of items*/
...
function Set(setID, setName, combinedSets, itemList, clusterIndex) {
...
function QueryGroup(groupID, groupName, orClauses, elements) {
